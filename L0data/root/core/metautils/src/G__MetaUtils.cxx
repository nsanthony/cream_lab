...
/* TClassEdit */
static int G__G__MetaUtils_96_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 3:
      {
...
static int G__G__MetaUtils_96_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) TClassEdit::IsDefAlloc((const char*) G__int(libp->para[0]), (const char*) G__int(libp->para[1])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__G__MetaUtils_96_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) TClassEdit::IsDefAlloc((const char*) G__int(libp->para[0]), (const char*) G__int(libp->para[1])
, (const char*) G__int(libp->para[2])));
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__G__MetaUtils_96_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) TClassEdit::IsDefComp((const char*) G__int(libp->para[0]), (const char*) G__int(libp->para[1])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__G__MetaUtils_96_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) TClassEdit::IsSTLBitset((const char*) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__G__MetaUtils_96_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G__G__MetaUtils_96_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) TClassEdit::IsStdClass((const char*) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__G__MetaUtils_96_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) TClassEdit::IsVectorBool((const char*) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__G__MetaUtils_96_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         string* pobj;
...
static int G__G__MetaUtils_96_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__G__MetaUtils_96_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TClassEdit::STLKind((const char*) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__G__MetaUtils_96_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TClassEdit::STLArgs((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__G__MetaUtils_96_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
      {
...
static int G__G__MetaUtils_96_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         string* pobj;
...
static int G__G__MetaUtils_96_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         string* pobj;
...
extern "C" void G__cpp_setup_typetableG__MetaUtils() {
   ...
   G__search_typename2("vector<TSchemaHelper>",117,G__get_linked_tagnum(&G__G__MetaUtilsLN_vectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgR),0,-1);
...
static void G__setup_memvarTClassEdit(void) {
   ...
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__G__MetaUtilsLN_TClassEditcLcLEModType),-1,-2,1,"kDropAllDefault=128",0,(char*)NULL);
   ...
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__G__MetaUtilsLN_TClassEditcLcLESTLType),-1,-2,1,"kBitSet=8",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__G__MetaUtilsLN_TClassEditcLcLESTLType),-1,-2,1,"kEnd=9",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncTClassEdit(void) {
   ...
   G__memfunc_setup("CleanType",901,G__G__MetaUtils_96_0_1, 117, G__get_linked_tagnum(&G__G__MetaUtilsLN_string), -1, 0, 3, 1, 1, 0, 
"C - - 10 - typeDesc i - - 0 '0' mode "
"C - - 12 '0' tail", (char*)NULL, (void*) G__func2void( (string (*)(const char*, int, const char**))(&TClassEdit::CleanType) ), 0);
   G__memfunc_setup("IsDefAlloc",950,G__G__MetaUtils_96_0_2, 103, -1, -1, 0, 2, 1, 1, 0, 
"C - - 10 - alloc C - - 10 - classname", (char*)NULL, (void*) G__func2void( (bool (*)(const char*, const char*))(&TClassEdit::IsDefAlloc) ), 0);
   G__memfunc_setup("IsDefAlloc",950,G__G__MetaUtils_96_0_3, 103, -1, -1, 0, 3, 1, 1, 0, 
...
"C - - 10 - valueclassname", (char*)NULL, (void*) G__func2void( (bool (*)(const char*, const char*, const char*))(&TClassEdit::IsDefAlloc) ), 0);
   G__memfunc_setup("IsDefComp",858,G__G__MetaUtils_96_0_4, 103, -1, -1, 0, 2, 1, 1, 0, 
"C - - 10 - comp C - - 10 - classname", (char*)NULL, (void*) G__func2void( (bool (*)(const char*, const char*))(&TClassEdit::IsDefComp) ), 0);
   G__memfunc_setup("IsSTLBitset",1050,G__G__MetaUtils_96_0_5, 103, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - type", (char*)NULL, (void*) G__func2void( (bool (*)(const char*))(&TClassEdit::IsSTLBitset) ), 0);
   G__memfunc_setup("IsSTLCont",835,G__G__MetaUtils_96_0_6, 105, -1, -1, 0, 2, 1, 1, 0, 
"C - - 10 - type i - - 0 '0' testAlloc", (char*)NULL, (void*) G__func2void( (int (*)(const char*, int))(&TClassEdit::IsSTLCont) ), 0);
   G__memfunc_setup("IsStdClass",989,G__G__MetaUtils_96_0_7, 103, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - type", (char*)NULL, (void*) G__func2void( (bool (*)(const char*))(&TClassEdit::IsStdClass) ), 0);
   G__memfunc_setup("IsVectorBool",1211,G__G__MetaUtils_96_0_8, 103, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - name", (char*)NULL, (void*) G__func2void( (bool (*)(const char*))(&TClassEdit::IsVectorBool) ), 0);
   G__memfunc_setup("GetLong64_Name",1274,G__G__MetaUtils_96_0_9, 117, G__get_linked_tagnum(&G__G__MetaUtilsLN_string), -1, 0, 1, 1, 1, 0, "u 'string' - 11 - original", (char*)NULL, (void*) G__func2void( (string (*)(const string&))(&TClassEdit::GetLong64_Name) ), 0);
   G__memfunc_setup("GetSplit",812,G__G__MetaUtils_96_0_10, 105, -1, -1, 0, 3, 1, 1, 0, 
"C - - 10 - type u 'vector<string,allocator<string> >' 'vector<std::string>' 1 - output "
"i - - 1 - nestedLoc", (char*)NULL, (void*) G__func2void( (int (*)(const char*, vector<std::string>&, int&))(&TClassEdit::GetSplit) ), 0);
   G__memfunc_setup("STLKind",633,G__G__MetaUtils_96_0_11, 105, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - type", "Kind of stl container", (void*) G__func2void( (int (*)(const char*))(&TClassEdit::STLKind) ), 0);
   G__memfunc_setup("STLArgs",640,G__G__MetaUtils_96_0_12, 105, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - kind", "Min number of arguments without allocator", (void*) G__func2void( (int (*)(int))(&TClassEdit::STLArgs) ), 0);
   G__memfunc_setup("ResolveTypedef",1457,G__G__MetaUtils_96_0_13, 117, G__get_linked_tagnum(&G__G__MetaUtilsLN_string), -1, 0, 2, 1, 1, 0, 
"C - - 10 - tname g - - 0 'false' resolveAll", (char*)NULL, (void*) G__func2void( (string (*)(const char*, bool))(&TClassEdit::ResolveTypedef) ), 0);
   G__memfunc_setup("ShortType",946,G__G__MetaUtils_96_0_14, 117, G__get_linked_tagnum(&G__G__MetaUtilsLN_string), -1, 0, 2, 1, 1, 0, 
"C - - 10 - typeDesc i - - 0 - mode", (char*)NULL, (void*) G__func2void( (string (*)(const char*, int))(&TClassEdit::ShortType) ), 0);
   G__memfunc_setup("InsertStd",928,G__G__MetaUtils_96_0_15, 117, G__get_linked_tagnum(&G__G__MetaUtilsLN_string), -1, 0, 1, 1, 1, 0, "C - - 10 - tname", (char*)NULL, (void*) G__func2void( (string (*)(const char*))(&TClassEdit::InsertStd) ), 0);
