// @(#)root/tmva $Id: myTMVAClassification.cxx 31458 2009-11-30 13:58:20Z stelzer $
/**********************************************************************************
...
int main( int argc, char** argv ) 
{
   ...
   if (Use["Categories"]) {
      ...
      TMVA::IMethod* cat = factory->BookMethod( TMVA::Types::kCategory, "Categories","" );
      TMVA::MethodCategory* mcat = dynamic_cast<TMVA::MethodCategory*>(cat);
      // std::cout << "BEFORE WE CALL AddMethod" << std::endl;
      mcat->AddMethod("(var3<1)&&(var4>0)","var3:var4:spec2:spec1:myvar1", TMVA::Types::kFisher,"myFisher","H:!V:Fisher:CreateMVAPdfs:PDFInterpolMVAPdf=Spline2:NbinsMVAPdf=60:NsmoothMVAPdf=10");
      // mcat->AddMethod("var3>1","", TMVA::Types::kFisher,"myFisher2","H:!V:Fisher:CreateMVAPdfs:PDFInterpolMVAPdf=Spline2:NbinsMVAPdf=60:NsmoothMVAPdf=10");
      // mcat->AddMethod("","var3:var4:spec1:spec2", TMVA::Types::kFisher,"myFisher3","H:!V:Fisher:CreateMVAPdfs:PDFInterpolMVAPdf=Spline2:NbinsMVAPdf=60:NsmoothMVAPdf=10");
      // mcat->AddMethod("","var1:var3:var4", TMVA::Types::kBDT,"myBDT","");
      // mcat->AddMethod("","var1:var3:var4", TMVA::Types::kKNN, "myKNN","H:nkNN=20:ScaleFrac=0.8:SigmaFact=1.0:Kernel=Gaus:UseKernel=F:UseWeight=T:!Trim");
      // std::cout << "AFTER WE CALL AddMethod" << std::endl;
   }
   // --------------------------------------------------------------------------------------------------
