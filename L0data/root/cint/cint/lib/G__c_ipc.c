...
void G__c_setup_tagtable() {
   ...
   G__tagtable_setup(G__get_linked_tagnum(&G__LN_ipc_parm),0,-2,0,(char*)NULL,NULL,NULL);
   G__tagtable_setup(G__get_linked_tagnum(&G__LN_ipc_perm),0,-2,0,(char*)NULL,NULL,NULL);
   G__tagtable_setup(G__get_linked_tagnum(&G__LN_shmid_ds),sizeof(struct shmid_ds),-2,0,(char*)NULL,G__setup_memvarshmid_ds,NULL);
   G__tagtable_setup(G__get_linked_tagnum(&G__LN_semid_ds),0,-2,0,(char*)NULL,NULL,NULL);
   G__tagtable_setup(G__get_linked_tagnum(&G__LN_msqid_ds),0,-2,0,(char*)NULL,NULL,NULL);
   G__tagtable_setup(G__get_linked_tagnum(&G__LN_semun),sizeof(union semun),-2,0,(char*)NULL,G__setup_memvarsemun,NULL);
   G__tagtable_setup(G__get_linked_tagnum(&G__LN_sembuf),sizeof(struct sembuf),-2,0,(char*)NULL,G__setup_memvarsembuf,NULL);
}
void G__c_setup() {
